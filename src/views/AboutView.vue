      ...
      <div class="container-fluid">
        <div class="row d-flex align-items-center">
          <div class="col-12 col-md-8 col-lg-8">
            <div class="right-bg">
              <img class="img-fluid" src="https://owirodigital.com/modern-images/about/About-us-img-1.jpg" alt="image">
            </div>
          </div>
      ...
      <div class="container-fluid">
        <div class="row d-flex">
          ...
          <div class="col-12 col-md-6 col-lg-6 order-0 order-md-1">
            <div class="right-bg">
              <img class="img-fluid" src="https://owirodigital.com/modern-images/about/About-us-img-2.jpg" alt="image">
            </div>
          </div>
        </div>
      </div>
